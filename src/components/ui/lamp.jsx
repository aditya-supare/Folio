  ...
  >
    <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
      ...
      >
        ...
        <div className="absolute w-40 h-[100%] left-0 bg-[#0E100F] bottom-0 z-20 [mask-image:linear-gradient(to_right,white,transparent)]" />
      </motion.div>
      <motion.div
        initial={{ opacity: 0.5, width: '15rem' }}
        whileInView={{ opacity: 1, width: '30rem' }}
      ...
      >
        <div className="absolute w-40 h-[100%] right-0 bg-[#0E100F] bottom-0 z-20 [mask-image:linear-gradient(to_left,white,transparent)]" />
